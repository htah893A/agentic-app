...
export function applyNagSuppressions(stack: Stack): void {
  ...
  // Justification: Bedrock and Aurora Serverless operations require wildcards for dynamic resources
  NagSuppressions.addStackSuppressions(stack, [
    {
      id: 'AwsSolutions-IAM5',
      reason: 'Wildcard permissions required for Bedrock Agent and Aurora Serverless (pgvector) operations',
    },
  ]);
